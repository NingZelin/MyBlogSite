...
<div id="app">
    <div class="top m-b-40">
        <div class="header text-center p-t-100 p-b-100 fs-44">NiZerin - 个人简历</div>
        <div class="flex text-center p-t-18 p-b-18 fs-18" v-show="top">NiZerin - 个人简历</div>
    </div>
    <div class="container">
        <div class="topinfo m-b-20 m-l-auto m-r-auto m-t-0">
            <p>世界在发展，尤其软件行业日新月异。我从未停止学习的脚步，请务必访问我的在线简历以获取最新信息。</p>
        ...
        <div class="cards m-b-20 m-l-auto m-r-auto m-t-0">
            <div class="card m-b-20">
                ...
                <ul class="m-t-12 m-b-12 p-l-32 fs-14">
                    <li><span class="point">NiZerin</span>／男／1998-02</li>
        ...
        <div class="lump m-l-auto m-r-auto card m-b-40">
            <p class="fs-16 m-b-20"><span class="point">基础扎实，学东西快，接触面广。</span> 十岁开始学习 Pascal 参加信息学奥赛，初中获得青岛市竞赛第一名；后自学 C 和 C++ 并从事 HTTP 协议抓包分析和 MFC 开发，高中退学专注于编程。</p>
            ...
            <p class="fs-16 m-b-20">熟悉与前端交互的原理（前端能得到什么、后端需要提供什么），但不了解前端具体实现和最新的 ES 标准。对于关系型数据库，停留在少量数据实际应用层面，对深入调优无经验。</p>
            <p class="fs-16"><span class="point">后端、运维向</span> 是我的强项；正努力成为 <a href="https://baike.baidu.com/item/T%E5%9E%8B%E4%BA%BA%E6%89%8D" class="link" target="_blank">T 型人才</a>。</p>
        </div>
        ...
        <div class="lump m-l-auto m-r-auto card m-b-40">
            <ul>
                ...
                <li>具备 <span class="code">Laravel 5</span>、<span class="code">Yii 2</span>、<span class="code">Symfony</span>、<span class="code">Tp5</span> 项目开发经验。</li>
